...
@onready var _bomb_spawner = preload("res://SceneObjs/Bomb/bomb_spawner.tscn")
@onready var _grapple_spawner = preload("res://SceneObjs/Grapple/grapple_spawner.tscn")
...
func _init_items() -> void:
	# Load the items
	_bomb_spawner = preload("res://SceneObjs/Bomb/bomb_spawner.tscn")
	_grapple_spawner = preload("res://SceneObjs/Grapple/grapple_spawner.tscn")
	_turret_spawner = preload("res://SceneObjs/Turret/gunner_turret.tscn")
